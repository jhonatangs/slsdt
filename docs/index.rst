...
.. figure:: images/oblique-split-iris.png

   Example of an oblique split in the iris dataset generated by our method
...
Moreover provides also a utility to load datasets included in the package
